// SYNC NOTE: Auto-generated copy for standalone copilot-plugin distribution. Source: plugin/scripts/device-store.mjs. Re-generate with: npm run sync:copilot-plugin
/*
