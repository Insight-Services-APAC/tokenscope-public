// SYNC NOTE: Auto-generated copy for standalone copilot-plugin distribution. Source: plugin/scripts/argv-guard.mjs. Re-generate with: npm run sync:copilot-plugin
/*
